								...
								<ul class="pagination">
									<c:if test="${pageMaker.prev}">
										<li class="page-item"><a class="page-link"
											href="mngList${pageMaker.makeSearch(pageMaker.startPage - 1) }"
									...
									<c:forEach begin="${pageMaker.startPage }"
										...
										<li class="page-item"
											...
											<a class="page-link" href="mngList${pageMaker.makeSearch(idx)}">${idx}</a>
										</li>
									</c:forEach>
									<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
										<li class="page-item"><a class="page-link"
											aria-label="Next"
											href="mngList${pageMaker.makeSearch(pageMaker.endPage +1) }"><span
