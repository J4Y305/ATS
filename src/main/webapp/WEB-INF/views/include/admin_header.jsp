			...
			<ul class="d-flex align-items-center">
				...
				<li class="nav-item dropdown pe-3"><a
					...
					href="#" data-bs-toggle="dropdown"> <img
						...
						class="d-none d-md-block dropdown-toggle ps-2">${login.adminId}</span>
				</a>
				<!-- End Profile Iamge Icon -->
					...
					<ul
						...
						<li class="dropdown-header">
							<h6>${login.adminId}</h6> <span>Web Designer</span>
						</li>
						<li>
							<hr class="dropdown-divider">
						</li>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="/admin/mngList"> <!-- <i class="bi bi-person"></i> --> <i
					class="bi bi-menu-button-wide"></i> <span>기업 관리</span>
			</a></li>
			<!-- End 상품 관리 Page Nav -->

			<li class="nav-item"><a class="nav-link collapsed"
				href="/admin/userList"> <i class="bi bi-person"></i> <span>회원
						관리</span>
			</a></li>
			<!-- End 기업 관리 Page Nav -->
	</aside>
