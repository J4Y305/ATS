			...
			<div class="row justify-content-center">
				<div
					...
					<div class="d-flex justify-content-center py-4">
						<a href="/mng/login" class="logo d-flex align-items-center w-auto">
					...
					<div class="card mb-3">
						...
						<div class="card-body">
							...
							<div class="pt-4 pb-2">
								<h5 class="card-title text-center pb-0 fs-4">기업담당자 로그인</h5>
								<p class="text-center small">Enter your ID & password
									to login</p>
							</div>
							...
							<form class="row g-3 needs-validation" action="/mng/loginPost"
								...
								<div class="col-12">
									<label for="mngId" class="form-label">ID</label>
								...
								<div class="col-12">
									<label for="adminPwd" class="form-label">Password</label> <input
										type="password" name="mngPwd" class="form-control"
								...
								<!-- <div class="col-12">
									<div class="form-check">
										<input class="form-check-input" type="checkbox"
											name="adminCookie" value="true" id="rememberMe"> <label
